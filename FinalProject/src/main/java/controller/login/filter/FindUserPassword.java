package controller.login.filter;
...
//									        GlobalService.KEY, tmp);
			...
			// 將這三項資料存入request物件
			request.setAttribute("rememberMe123", rememberMe);
			request.setAttribute("user123", user);
			request.setAttribute("password123", password);
		}
